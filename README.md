...
- [ ] 如何更好的输出审核结果
- [ ] 结巴分词和TF-IDF算法计算文本相似度，实现报告查重
- [ ] 增加对 .ppt 的支持，目前的idea是转化为pptx再审核
- [ ] 使用 Server 酱实现提醒开发者修改BUG！
- [ ] :bug: 
---
...
- 替换所有出现的商品名为通用名，给出替换了几次的通知，替换列表如下：
    ...
    商品名 | 通用名 | 商品名 | 通用名
    :-:|:-:|:-:|:-:
    诺和锐30 | 门冬胰岛素30注射液 | 安达唐 | 达格列净片
    诺和锐50 | 门冬胰岛素50注射液 | 格华止 | 盐酸二甲双胍片
    锐30 | 门冬胰岛素30注射液 | 美哒灵 | 二甲双胍缓释片
    锐50 | 门冬胰岛素50注射液 | 麦克罗辛 | 二甲双胍缓释片
    诺和锐 | 门冬胰岛素 | 君力达 | 二甲双胍肠溶胶囊
    优泌乐 | 赖脯胰岛素注射液 | 美迪康 | 二甲双胍片
    诺和达 | 德谷胰岛素注射液 | 文迪雅 | 盐酸罗格列酮
    诺和平 | 地特胰岛素注射液 | 卡司平 | 盐酸吡格列酮片
    来得时 | 甘精胰岛素注射液 | 艾汀 | 盐酸吡格列酮片
    诺和灵30R | 精蛋白生物合成人胰岛素注射液(预混30R） | 艾可拓 | 盐酸吡格列酮片
    诺和灵50R | 精蛋白生物合成人胰岛素注射液(预混50R） | 安多健 | 盐酸吡格列酮分散片
    诺和灵 | 精蛋白生物合成人胰岛素注射液 | 倩尔 | 盐酸吡格列酮胶囊
    甘舒霖 | 混合重组人胰岛素注射液 | 糖适平 | 格列喹酮片
    优泌林 | 精蛋白锌重组人胰岛素混合注射液 | 唐弗 | 格列美脲胶囊
    诺和生 | 注射用生物合成胰高血糖素 | 万苏平 | 格列美脲片
    优思灵 | 精蛋白重组人胰岛素注射液 | 亚莫利 | 格列美脲片
    诺和力 | 利拉鲁肽注射液 | 阿莫利 | 格列美脲片
    百泌达 | 艾塞那肽 | 佑苏 | 格列美脲片
    百达杨 | 长效艾塞那肽 | 秦苏 | 格列吡嗪缓释片
    倍欣 | 伏格列波糖片 | 乐透福 | 格列吡嗪控释片
    卡博平 | 阿卡波糖片 | 瑞易宁 | 格列吡嗪控释片
    拜唐苹 | 阿卡波糖片 | 达美康 | 格列齐特缓释片
    华怡平 | 伏格列波糖片 | 先求 | 格列齐特缓释片
    佳维乐 | 维格列汀片 | 迪方 | 那格列奈
    捷诺维 | 西格列汀片 | 联邦 | 那格列奈
    安立泽 | 沙格列汀片 | 唐力 | 那格列奈
    欧唐宁 | 利格列汀片 | 孚来迪 | 瑞格列奈片
